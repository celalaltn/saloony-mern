...
const CreateIncomePage: React.FC = () => {
  ...
  const createIncomeMutation = useMutation({
    mutationFn: (data: any) => financeApi.createIncome(data),
    onSuccess: () => {
    ...
    onError: (error: any) => {
      setError(error.message || 'Gelir kaydı oluşturulurken bir hata oluştu')
    }
  })
  ...
  const isLoading = createIncomeMutation.isPending
            ...
            <Grid item xs={12}>
              <Box display="flex" justifyContent="flex-end" gap={2}>
                ...
                <Button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? <CircularProgress size={24} /> : 'Gelir Ekle'}
                </Button>
              </Box>
            </Grid>
          </Grid>
